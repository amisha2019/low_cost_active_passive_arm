...
class SimulatedRobot:
    ...
    def set_target_pos(self, target_pos):
        ...
        '''
        # incoming target pose: [-1.57, -1.57, -1.57, -1.57, -1.57, 1.57, 1.57]
        simulation_offset = np.array([1.57, 1.57, 1.57, 1.57, -1.57, -1.57])
        simulation_input_pose = target_pos + simulation_offset

        simulation_input_pose[2] = -simulation_input_pose[2]
        simulation_input_pose[3] = -simulation_input_pose[3]
        self.d.ctrl = simulation_input_pose
        print("Simulation: ", self.d.ctrl)
